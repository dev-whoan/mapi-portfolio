...
const pool = mariadb.createPool({
    host: process.env.mapi_host || dbInfo.host,
    port: process.env.mapi_port || dbInfo.port,
    user: process.env.mapi_user || dbInfo.id,
    password: process.env.mapi_password || dbInfo.pw,
    connectionLimit: 5,
    database: process.env.mapi_scheme || dbInfo.scheme
});
